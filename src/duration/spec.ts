import { DAYS_IN_MONTH, DAYS_IN_WEEK, DAYS_IN_YEAR, HOURS_IN_DAY, MILLISECONDS_IN_DAY, MILLISECONDS_IN_HOUR, MILLISECONDS_IN_MINUTE, MILLISECONDS_IN_MONTH, MILLISECONDS_IN_SECOND, MILLISECONDS_IN_WEEK, MILLISECONDS_IN_YEAR, MINUTES_IN_HOUR, SECONDS_IN_MINUTE } from '../constants';
...
describe('Duration', () => {
    ...
    describe('weeks', () => {
        ...
        it('toSeconds', () => {
            expect(Duration.weeks(1).toSeconds()).toEqual(1 * DAYS_IN_WEEK * HOURS_IN_DAY * MINUTES_IN_HOUR * SECONDS_IN_MINUTE);
        });
    ...
    describe('months', () => {
        ...
        it('toSeconds', () => {
            expect(Duration.months(1).toSeconds()).toEqual(1 * DAYS_IN_MONTH * HOURS_IN_DAY * MINUTES_IN_HOUR * SECONDS_IN_MINUTE);
        });
